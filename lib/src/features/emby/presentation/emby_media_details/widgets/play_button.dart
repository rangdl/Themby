      ...
      child: Container(
        ...
        child: (item.userData?.playedPercentage != null && item.type != 'Series')
            ? _playResume(
                ...
                remainingTime(item.runTimeTicks! - item.userData!.playbackPositionTicks!),
                context,
                width)
            : _play(context),
      ),
  ...
  Widget _play(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        Text("播放",
            style: StyleString.titleStyle.copyWith(color: Theme.of(context).colorScheme.onPrimary)),
      ],
    );
  }
  ...
  Widget _playResume(double percentage, String text, BuildContext context, double width) {
    return Row(
      ...
      children: [
        ...
        Text(
          "剩 $text",
          style: StyleString.titleStyle.copyWith(
